  ...
  return (
    <div className="w-full h-[90vh] p-8">
      <div className="w-full bg-white h-full rounded flex items-center justify-center flex-col">
        ...
        <div
          className={`${styles.button} text-white !bg-pink-600 !h-[42px] !rounded font-medium`}
            ...
            {paymentMethod ? (
              <div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <button
                    type="submit"
                    className={`${styles.button} mb-3 mt-14 text-white !bg-blue-500`}
                  >
                    Add
                  </button>
                </form>
                ...
                {seller && seller?.withdrawMethod ? (
                  <div>
                    ...
                    <div className="800px:flex w-full items-center">
                      ...
                      />
                      <div
                        className={`${styles.button} !h-[42px] text-white !bg-green-500`}
                  ...
                  <div>
                    ...
                    <div className="w-full flex items-center">
                      <div
                        className={`${styles.button} !text-[#fff] text-[18px] mt-4 bg-blue-500`}
