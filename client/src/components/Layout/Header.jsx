      ...
      <div className={`${styles.section}`}>
        <div className="hidden 800px:h-[50px] 800px:my-[20px] 800px:flex items-center justify-between">
          <div>
            <Link
              to="/"
              className="text-3xl font-bold text-purple-900 uppercase"
            >
              Opstra
            </Link>
          </div>
          ...
          <div className="w-[50%] relative">
            <input
              ...
              className="h-[40px] w-full px-2 border-none border-[2px] rounded-md"
            />
            <AiOutlineSearch
              size={30}
              ...
              <div className="absolute min-h-[30vh] bg-slate-50 shadow-sm-2 z-[9] p-4">
                {searchData &&
                  searchData.map((i, index) => {
                    return (
                      <Link key={i.index} to={`/product/${i._id}`}>
          ...
          <div className={`${styles.button}`}>
            <Link to={`${isSeller ? "/dashboard" : "/shop-create"}`}>
              <h1 className="text-black font-semibold flex items-center">
        ...
        {open && (
          ...
          >
            <div className="fixed w-[70%] bg-[#fff] h-screen top-0 left-0 z-10 overflow-y-scroll ">
                ...
                {searchData && searchData.length > 0 && (
                  <div className="absolute bg-[#fff] z-10 shadow w-full left-0 p-3">
                    {searchData.map((item) => {
                      ...
                      return (
                        <Link to={`/product/${Product_name}`} key={item.id}>
              ...
              <Navbar active={activeHeading} />
              <div className={`${styles.button} ml-4 !rounded-[4px] !bg-black`}>
                <Link to="/shop-create">
